...
public interface MallOrderDetailDAO extends BaseDAO<MallOrderDetail> {
    ...
    IPage<MallOrderDetail> selectSelective(Page<MallOrderDetail> page, @Param("wq") MallOrderDetail mallOrderDetail);

    List<MallOrderDetail> selectSelective(@Param("wq") MallOrderDetail mallOrderDetail);
}